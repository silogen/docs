...
Select the collection you want to upload the document to, and click on the "Upload" button under the "Actions" menu.
...
You can alternatively scrape the contents of a website into a collection. To do this, click on the "Scrape Website" button under the "Actions" menu, and enter the URL of the website you want to scrape. You can also specify the number of pages to scrape from the website.
...
You can also choose to delete the entire collection by clicking on the "Delete" button on the after selecting the collection, in the "Collection Info" section. Deleting a collection will delete all the documents indexed in the collection and cannot be undone.
