...
The tutorials start with a shared setup: [Tutorial 0](../ai-workloads-docs/tutorials/tutorial-00-prerequisites.md). It covers the tools, but also has a required scluster setup step that needs to be run.
